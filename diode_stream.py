...
USERNAME ="diode",
PASSWORD ="9c7TCRO"
STM_to_Intersection_ID = {"383135333431511600330032":"53694", "3831353334315104001C002A":"12544", "38313533343151160034003C":"179"}
cursor = 0
...
async def receive():
    ...
    async def help_request(msg):
        ...
        if(intersection_id == "179"):
            print("Received a message on {subject} : {spat_hex_result}".format(subject=intersection_id, spat_hex_result=hex_result[:-8]))
            #print("Received a message on {subject} : {spat_hex_result}".format(subject=intersection_id, spat_hex_result=spat_data))
